...
/**
 * @deprecated use \TeBo\Telegram\Response::newMessage()->setReplyKeyboard(...) instead.
 */
class ReplyKeyboard extends HtmlMessage implements ResponseInterface
{
    ...
    // ... (addButton y addButtons se mantienen igual) ...
